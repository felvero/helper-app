...
onSubmit() {
  ...
  // );
  this.authService.trainerRegister(this.form.firstName, this.form.lastName, this.form.email, this.form.password, this.form.phoneNumber, this.form.yearOfBirth, this.form.actualGym)
    .subscribe({
      next: data => {
        console.log(data);
      },
